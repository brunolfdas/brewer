...
public class EstilosController {
	...
	public ModelAndView salvar(@Valid Estilo estilo, BindingResult result, Model model,
		...
		// tratamento para verificar se o nome do estilo já existe
		try {
	...
	// metodo para tratar o modal. E pegar os dados que vem do json do javascript
	// transforma o json em um objeto java
	...
	private @ResponseBody ResponseEntity<?> excluir(@PathVariable("codigo") Estilo estilo){
		try {
