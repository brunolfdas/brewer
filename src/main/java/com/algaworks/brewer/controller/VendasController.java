...
public class VendasController {
	...
	//passando os parametros desta maneira não precisa usar "Cerveja cerveja = cervejas.findOne(codigoCerveja);" como no metodo acima
	...
	@GetMapping
	public ModelAndView pesquisar(VendaFilter vendaFilter, BindingResult result,@PageableDefault(size = 10) Pageable pageable, HttpServletRequest httpServletRequest) {
